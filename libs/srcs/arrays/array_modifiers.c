/*
** array_modifiers.c for array modifiers in /home/roche_g/dataStructures/lists/oop
** 
** Made by 
** Login   <roche_g@epitech.net>
** 
** Started on  Mon Mar 14 02:42:04 2016 
** Last update Sat Mar 19 21:31:39 2016 
*/
...
int		array_insert_at(Object *container, void *data, int pos)
{
  void		**res;
  t_container	*self;
...
int		array_delete_at(Object *container, int pos)
{
  t_container	*self;
  void		**res;
  int		i;
...
int		array_erase(Object *container)
{
  t_container	*self;
